...
export class PersonaJuridicaController {
  ...
  @Post(':id')
  create(@Param('id') idTitulo:string,@Body() createPersonaJuridicaDto: CreatePersonaJuridicaDto) {
    return this.personaJuridicaService.create(idTitulo,createPersonaJuridicaDto);
  }
